              ...
              <div _ngcontent-vei-c1="" class="no-padding col-md-9 col-sm-12 col-12"><!---->
                <span _ngcontent-vei-c1="">
                  <div _ngcontent-vei-c1="" class="no-padding col-md-12 col-sm-12 col-12 font-weight-bold pl-0 hd-txt1"><!---->
                    ...
                    <span _ngcontent-vei-c1="">Who Viewed</span><!----> your number <!----><!----><!---->
...
<section style="background-color: #fff;">
  <div class="container">
    <div class="row">
        ...
        <?php 
            $profile_id=array();
            $data = mysqli_query($db, "SELECT profile_id FROM `view_list` WHERE `u_id` = '$u_id'");
            while ($data_data = mysqli_fetch_assoc($data)) {
                $profile_id[] = $data_data['profile_id'];
            }
