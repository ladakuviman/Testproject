...
<script type="text/javascript" src="../assets1/build/jquery.datetimepicker.full.js"></script>
	...
	loadScript(plugin_path + "datatables/js/dataTables.tableTools.min.js", function()
        {
            loadScript(plugin_path + "datatables/dataTables.bootstrap.js", function()
            {
                loadScript(plugin_path + "select2/js/select2.full.min.js", function(){
                    ...
                    /*plan search datatable*/
                    var tableplan = jQuery('#datatable_sample');
                    ...
                    var oTablePlan = tableplan.dataTable({
                        "columns": [{
                            "orderable": false
                        }, {
                            "orderable": true
