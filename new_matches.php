...
$data = mysqli_fetch_assoc(mysqli_query($db, "SELECT `logout_time` FROM `log_details` WHERE `u_id` = '$u_id'"));

$logout_time = $data['logout_time'];

$user_id=array();

$data = mysqli_query($db, "SELECT t1.*,t8.* FROM register t1 LEFT JOIN `register1` t8 ON t8.`u_id` = t1.`u_id` WHERE t1.`date` >= '$logout_time' AND t8.gender = '$new_gender' ");
              ...
              <div _ngcontent-vei-c1="" class="no-padding col-md-9 col-sm-12 col-12"><!---->
                <span _ngcontent-vei-c1="">
                  <div _ngcontent-vei-c1="" class="no-padding col-md-12 col-sm-12 col-12 font-weight-bold pl-0 hd-txt1"><!---->
                    ...
                    <span _ngcontent-vei-c1="">New match</span><!----> based on your preferences <!----><!----><!---->
                    <h6 _ngcontent-wqd-c1="">These are new members matching your preferences who have joined in the last one month</h6>
                  </div>
                </span><!---->
              </div><!----><!---->
      ...
      <?php 
        if($user_id == NULL){ ?>
          ...
          <div class="col-md-12 col-sm-12 col-12" style="text-align: center;margin-top: 115px;min-height: 115px;">
            <span>Currently, there are no profiles available</span>
          </div>
