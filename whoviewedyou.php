  ...
  <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12  " style="margin-top: 25px;">
               <h3><strong>Who Viewed You</strong></h3>
            </div>
              ...
              <div style="color:#535353; font-size:13px;" class="reg-box">
                  ...
                  <div class="row  to-fmid" >
                      ...
                      <div class="card border-bottom border-radius-7">
                        ...
                        <div class="accordion-body">
                          <ul class="activity-lists">
                            ...
                            <li><a routerlink="whoviewedyou.php" class="active-org" href="whoviewedyou.php">
                    ...
                    <div class="col-sm-9">
                      <?php 
                      $profile_id=array();
                      $data = mysqli_query($db, "SELECT u_id FROM `view_list` WHERE `profile_id` = '$u_id'");
