<?php include("header1.php"); 
    ...
    //$data = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM `register1` WHERE `u_id` = '$u_id'"));
    //$age = $data['age'];
...
<style type="text/css">
  ...
  img[_ngcontent-shk-c4] {
    ...
    .viewBtnsend-interst {
        ...
        border: 2px solid #06c206!important;
        color: #fff;
        line-height: 15px;
        font-weight: 700;
        font-size: 14px;
...
<!-- <div _ngcontent-vei-c1="" class="container-fluid">
  <div _ngcontent-vei-c1="" class="container custom-container">
    <div _ngcontent-vei-c1="" class="row">
      <div _ngcontent-vei-c1="" class="col-md-12 col-sm-12 colxs-12">
        <div _ngcontent-vei-c1="" class="row mt-0 bg-white">
          <div _ngcontent-vei-c1="" class="col-md-12 col-sm-12 col-12">
            <div _ngcontent-vei-c1="" class="row mt-4">
              <div _ngcontent-vei-c1="" class="no-padding col-md-9 col-sm-12 col-12">
                <span _ngcontent-vei-c1="">
                  <div _ngcontent-vei-c1="" class="no-padding col-md-12 col-sm-12 col-12 font-weight-bold pl-0 hd-txt1">
                    <span _ngcontent-vei-c1="">7</span>&nbsp; 
                    <span _ngcontent-vei-c1="">Matches</span> based on your preferences 
                  </div>
                </span>
              </div>
              <div _ngcontent-vei-c1="" class="no-padding col-md-3 col-sm-12 col-12 clr-orange1 text-right">
                <div _ngcontent-vei-c1="" class="mt-2 cursor-pointer" ><a href="preference.php" style="color: #ed6402!important;">Edit preferences for relevant matches</a> 
                  <img _ngcontent-vei-c1="" class="ml-2" src="https://imgs.hindimatrimony.com/bmimgs/desktop-images/myhome-rght-arw.png?v=0.5392983670098306">
                </div>
              </div>
            </div>
          </div>
                                  ...
                                  <div _ngcontent-shk-c28="" class="row">
                                    <app-buttons _ngcontent-shk-c28="" class="d-flex align-items-center" _nghost-shk-c19="">
                                      ...
                                      <div _ngcontent-shk-c19="" class="figure  col-md-6 col-sm-6">
                                        <?php
                                            $interest_list_details = mysqli_query($db,"SELECT * FROM `interest_list` WHERE `u_id` = '$full_data[u_id]' AND `status` = '1'");
                                            $c = mysqli_num_rows($interest_list_details);
                                                if($c > 0) { ?>

                                            <button _ngcontent-pth-c11="" class="viewBtnsend-interst mx-3 information-sent " type="button"> Accepted </button>

                                        <?php } else { ?>

                                            <button type="submit" class="viewBtnsend-interst mx-3 AcceptInterest" u_id="<?php echo isset($u_id)?$u_id:''?>" profile_id="<?php echo isset($full_data['u_id'])?$full_data['u_id']:''?>">Accept Interest</button>

                                        <?php } ?>
                                      </div>
                                      <div _ngcontent-shk-c19="" class="figure pl-md-2 col-md-6 col-sm-6">
                                        <?php
                                            $short_list_details = mysqli_query($db,"SELECT * FROM `interest_list` WHERE `u_id` = '$full_data[u_id]' AND status = '2'");
                                            $c = mysqli_num_rows($short_list_details);
                                                if($c > 0) { ?>

                                                <button _ngcontent-pth-c11="" class="viewBtnsend-interst mx-3 information-sent " type="button"> Rejected </button>

                                            <?php } else { ?>

                                                <button _ngcontent-shk-c19="" class="viewBtnsend-shortlist RejectInterest" type="button"  profile_id="<?php echo isset($full_data['u_id'])?$full_data['u_id']:''?>">
                                                  <span _ngcontent-shk-c19="" class="short-icon">Reject Interest</span>
                                                </button>
