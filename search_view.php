              ...
              <div _ngcontent-vei-c1="" class="no-padding col-md-9 col-sm-12 col-12"><!---->
                <span _ngcontent-vei-c1="">
                  <div _ngcontent-vei-c1="" class="no-padding col-md-12 col-sm-12 col-12 font-weight-bold pl-0 hd-txt1"><!---->
                    <span _ngcontent-vei-c1=""></span><!----> <!---->
                    <span _ngcontent-vei-c1="">Premium match</span><!----> based on your preferences <!----><!----><!---->
                    <h6 _ngcontent-wqd-c1="">This section contains premium members along with members who were once premium</h6>
                  </div>
                </span><!---->
              </div><!----><!---->
  ...
  <div class="container">
    ...
    <div class="col-sm-9">
      ...
      while ($full_data = mysqli_fetch_assoc($full1_data))
      {
        ...
        ?>
      <div class="col-sm-12">
        <div style="color:#535353; font-size:13px;margin-bottom: 10px;" class="">
          <div class="row " >
                              ...
                              <div _ngcontent-shk-c28="" class="row">
                                <app-buttons _ngcontent-shk-c28="" class="d-flex align-items-center" _nghost-shk-c19="">
                                  ...
                                  <div _ngcontent-shk-c19="" class="figure  col-md-6 col-sm-6">
                                    <?php
                                      $interest_list_details = mysqli_query($db,"SELECT `profile_id` FROM `interest_list` WHERE `profile_id` = $full_data[u_id]");
                                  ...
                                  <div _ngcontent-shk-c19="" class="figure pl-md-2 col-md-6 col-sm-6">
                                    <?php
                                      $short_list_details = mysqli_query($db,"SELECT `profile_id` FROM `short_list` WHERE `profile_id` = $full_data[u_id]");
